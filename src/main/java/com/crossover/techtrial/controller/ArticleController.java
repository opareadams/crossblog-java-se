...
public class ArticleController {
  ...
  public ResponseEntity<Article> updateArticle(@PathVariable("article-id") Long id,
	  ...
	  Article recentArticle = articleService.findById(id);
	    recentArticle.setEmail(article.getEmail());
	    recentArticle.setTitle(article.getTitle());
	    recentArticle.setContent(article.getContent());
	    recentArticle.setDate(article.getDate());
	    recentArticle.setPublished(article.getPublished());
